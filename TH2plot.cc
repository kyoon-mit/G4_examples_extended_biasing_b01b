...
// Use: root -l TH2plot.cc'(input, output, TTree directory)'
...
void TH2plot (const char *input_file = "B01b.root",
              const char *output_file = "2d_histograms_complete.root",
...
{  
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# of secondaries", 20, 0, 200);
    return hist;
  }
  ...
  {   
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "energy deposit [MeV]", 30, 0, 15000);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "energy deposit [MeV]", 25, 0, 50);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# tracks entering", 20, 0, 2000);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# tracks entering", 20, 0, 10);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# tracks exiting", 20, 0, 100);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# tracks exiting", 20, 0, 10);
    return hist;    
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# hits", 40, 0, 2000);
    return hist;
  }
  ...
  {
    // Create histogram
    TH2F *hist = hist_layer(t, num_events, branchname, "", "# hits", 25, 0, 250);
    return hist;
  }
