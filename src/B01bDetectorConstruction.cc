...
// ********************************************************************
//
/// \file biasing/B01b/src/B01bDetectorConstruction.cc
/// \brief Implementation of the B01bDetectorConstruction class
//
//
//
...
B01bDetectorConstruction::B01bDetectorConstruction() :
...
G4VPhysicalVolume* B01bDetectorConstruction::Construct()
{
  G4double pos_x;
  G4double pos_y;
  G4double pos_z; 
...
G4VIStore* B01bDetectorConstruction::CreateImportanceStore()
{
  G4cout << " B01bDetectorConstruction:: Creating Importance Store " << G4endl;
  if (!fPhysicalVolumeVector.size())
  {
    G4Exception("B01bDetectorConstruction::CreateImportanceStore"
               ,"exampleB01b_0001",RunMustBeAborted
...
G4VWeightWindowStore *B01bDetectorConstruction::CreateWeightWindowStore()
{
  if (!fPhysicalVolumeVector.size())
  {
    G4Exception("B01bDetectorConstruction::CreateWeightWindowStore"
               ,"exampleB01b_0002",RunMustBeAborted
               ,"no physical volumes created yet!");
  }
...
G4String B01bDetectorConstruction::GetCellName(G4int i)
{
...
G4VPhysicalVolume *B01bDetectorConstruction::GetWorldVolume() {
   return fWorldVolume;
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void B01bDetectorConstruction::SetSensitive(){
...
void B01bDetectorConstruction::ConstructSDandField()
{
