...
// ********************************************************************
//
/// \file biasing/B01b/src/B01bRun.cc
/// \brief Implementation of the B01bRun class
//
//
//
...
//
//  (Description)
//    B01bRun Class is for accumulating scored quantities which is 
//  scored using G4MutiFunctionalDetector and G4VPrimitiveScorer.
//  Accumulation is done using G4THitsMap object.
//
//    The constructor B01bRun(const std::vector<G4String> mfdName)
...
//  Then B01bRun constructor automatically scans primitive scorers
...
// 
//    The resultant information is kept inside B01bRun objects as
//  data members.
...
B01bRun::B01bRun(const std::vector<G4String> mfdName): G4Run()
{
...
void B01bRun::RecordEvent(const G4Event* aEvent)
{
...
G4THitsMap<G4double>* B01bRun::GetHitsMap(const G4String& detName,
...
G4THitsMap<G4double>* B01bRun::GetHitsMap(const G4String& fullName){
...
void B01bRun::Merge(const G4Run* aRun)
{
  const B01bRun * localRun = static_cast<const B01bRun *>(aRun);
  //=======================================================
